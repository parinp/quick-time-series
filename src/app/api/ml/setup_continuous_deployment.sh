...
REPO_NAME="ml-analysis-api"
REGION="us-central1"
SERVICE_ACCOUNT="cloud-build-service-account"
...
# Create a Cloud Source Repository (optional - you can use GitHub/GitLab instead)
...
gcloud iam service-accounts create $SERVICE_ACCOUNT \
    --display-name="Cloud Build Service Account" || echo "Service account already exists"
